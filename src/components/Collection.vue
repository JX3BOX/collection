<template>
    <div class="c-collection">
        ...
        >
            <img
                class="u-image"
                :src="$options.filters.cover_url(collection.image)"
            />
        </router-link>
        <div class="m-content">
            <a :href="collection.user_id | author_url" class="m-user" target="_blank">
                <img
                    class="u-avatar"
                    :src="get_thumbnail(collection.user_avatar, 20)"
                />
                <span
                    class="u-nickname"
            ...
            <div
                class="u-updated"
                v-text="'最后更新于 ' + date_format(collection.updated)"
            ></div>
            <router-link
                class="u-title"
